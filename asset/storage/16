...
if not toolsArray then -- no one has made build tools yet, we get to!
	...
	if not useNewTools then
		table.insert(buildToolIds,55028088) -- StamperTool
		table.insert(buildToolIds,36738185) -- DeleteTool
		table.insert(buildToolIds,55027987) -- ConfigTool
		table.insert(buildToolIds,58880579) -- RotateTool
		table.insert(buildToolIds,60791062) -- WiringTool
